...
export const works: Work[] = [
  {
    ...
    description: "대련의 거리와 빛, 사람 사이의 순간을 엮은 21초의 여행 영화.",
    summaryEn: "A short film of Dalian's streets, movement, and quiet intervals.",
    format: "Short travel film · 00:21",
    location: "Dalian, China · 2026",
    purpose: "대련에서 마주한 거리와 사람을 짧은 영상으로 남겼습니다. 장소를 설명하기보다 그곳에서 느낀 속도를 기록하고 싶었습니다.",
    concept: "도시가 움직이는 장면과 잠시 멈춰 바라보는 장면을 교차시켰습니다.",
    process: "넓은 도시 풍경에서 거리의 움직임, 인물의 시선으로 점차 가까워지도록 컷을 고르고 색과 리듬을 맞췄습니다.",
    challenge: "21초 안에 여러 장소를 담으면서도 장면이 너무 빨리 지나가지 않도록 호흡을 조절했습니다.",
    reflection: "도시의 규모와 가까운 순간을 함께 담았습니다. 다음에는 현장에서 들은 소리도 더 오래 남겨두고 싶습니다.",
    role: ["Direction", "Film", "Edit", "Color"],
    tools: ["Final Cut Pro"],
    media: [{ kind: "film", id: "dalian-2026" }],
    archiveMeta: {
      city: "Dalian",
      country: "China",
      medium: "Film",
    ...
    thumbnail: "/media/dalian/frame-opening.jpg",
    thumbnailAlt: "푸른 저녁빛 아래 펼쳐진 대련 도심",
    thumbnailAspect: "wide",
    thumbnailRatio: "16 / 9",
    detailImages: [
      {
        src: "/media/dalian/frame-motion.jpg",
        alt: "대련 도심의 도로를 가로지르는 버스",
        aspect: "wide",
        ratio: "16 / 9",
      },
      {
        src: "/media/dalian/frame-night.jpg",
        alt: "도시를 내려다보며 앉아 있는 인물",
        aspect: "wide",
        ratio: "16 / 9",
      },
      {
        src: "/media/dalian/frame-finale.jpg",
        alt: "대련의 거리를 따라 걸어가는 인물",
        aspect: "wide",
        ratio: "16 / 9",
      },
    ],
  ...
  },
  {
    ...
    thumbnail: "/media/films/hanoi-sapa-2026-poster.jpg",
    thumbnailAlt: "하노이와 사파 여행 영상의 장면",
    thumbnailAspect: "wide",
    thumbnailRatio: "16 / 9",
    detailImages: [
      {
        src: "/media/films/qingdao-2025-poster.jpg",
        alt: "칭다오의 나무가 늘어선 거리를 걷는 사람",
        aspect: "portrait",
        ratio: "9 / 16",
      },
      {
        src: "/media/films/phu-quoc-2023-poster.jpg",
        alt: "푸꾸옥 바닷가를 걷는 두 사람",
        aspect: "wide",
        ratio: "16 / 9",
      },
    ],
