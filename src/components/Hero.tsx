    ...
    <section className="hero-band overflow-hidden">
      <Container className="grid grid-cols-1 gap-8 lg:grid-cols-[1fr_420px] lg:items-center">
        <Reveal>
          ...
          <p className="sub-heading mt-6 max-w-[640px] text-ink">
            {profile.title}
          </p>
        ...
        <Reveal delay={0.1}>
          <Link
            ...
            className="card block border border-ink"
          >
            ...
            <div className="mt-6">
              ...
              <h2 className="display-md mt-3 text-ink">{featuredWork.title}</h2>
              <p className="body-copy mt-4 truncate">{featuredWork.description}</p>
            </div>
          </Link>
        </Reveal>
      </Container>
