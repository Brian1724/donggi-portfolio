...
- Rendering is on demand and stops offscreen. Pixel ratio is capped at 1.5. Scroll drives a damped front-to-rear camera arc, subtle lift and lens push, then opens and swivels the LCD from the physical hinge side in sequence. Scrolling upward reverses the motion; reduced-motion shows a composed static open pose.
